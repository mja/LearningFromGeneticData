...
$$H^2 = \frac{\mathrm{var}(G)}{\mathrm{var}(𝑃)}, e^2 = \frac{\mathrm{var}(E)}{\mathrm{var}(𝑃)}$$
$$H^2 + e^2 = 1$$
...
Add a shared (or "common") environment to the basic genetic model, to capture similarity between relatives attributable to environmental factors
...
twins_ac = tribble(
  ...
  "MZ", "Genetic", 0.5,
  "MZ", "Shared Environment", 0.25,
  "DZ", "Genetic", 0.25,
  "DZ", "Shared Environment", 0.25
)
